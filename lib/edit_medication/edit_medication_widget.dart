...
class _EditMedicationWidgetState extends State<EditMedicationWidget> {
  ...
  void initState() {
    ...
    _model.textController1 ??= TextEditingController(text: 'Name Medication');
    _model.textFieldFocusNode1 ??= FocusNode();

    _model.textController2 ??= TextEditingController(text: '100 mg');
    _model.textFieldFocusNode2 ??= FocusNode();

    _model.textController3 ??= TextEditingController(text: '1x daily');
